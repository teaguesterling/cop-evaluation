"""Tests for cop_python.testing.foundation module."""
...
class TestUtilityFunctions(unittest.TestCase):
    ...
    def test_get_current_component(self):
        ...
        get_system().push_context("test_concept", test_component)
    ...
    def test_nested_contexts(self):
        ...
        # First context
        get_system().push_context("test_concept", component1)
        self.assertEqual(get_current_component(), component1)
        
        # Nested context
        get_system().push_context("test_concept", component2)
