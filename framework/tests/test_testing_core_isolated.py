"""Isolated tests for cop_python.testing.core module."""

import unittest
import inspect
from cop_python.runtime import enable_cop, disable_cop, get_system, SourceInfo
# Import directly from testing.core to avoid circular dependencies
import cop_python.testing.core as testing_core
...
class TestTestsConcept(unittest.TestCase):
    ...
    def test_context_manager_usage(self):
        ...
        self.assertIsNone(testing_core.get_current_component())
        
        # Use as context manager
        with testing_core.tests_concept(self.test_component_setup):
            # Component should be available inside context
            self.assertEqual(testing_core.get_current_component(), self.test_component_setup)
    ...
    def test_function_decorator(self):
        ...
        @testing_core.tests_concept(self.test_component_setup)
        def test_function():
            # Inside the test function, component should be available
            return testing_core.get_current_component()
...
class TestUtilityFunctions(unittest.TestCase):
    ...
    def test_get_current_component(self):
        ...
        self.assertEqual(testing_core.get_current_component(), test_component)
    ...
    def test_annotation_type_context(self):
        ...
        # Initially should be None
        self.assertIsNone(testing_core.get_current_annotation_type())
        
        # Set annotation type
        testing_core.set_current_annotation_type("invariant")
        self.assertEqual(testing_core.get_current_annotation_type(), "invariant")
        
        # Set another type
        testing_core.set_current_annotation_type("risk")
        self.assertEqual(testing_core.get_current_annotation_type(), "risk")
    ...
    def test_get_test_id(self):
        ...
        test_id = testing_core.get_test_id(simple_test)
        ...
        test_id = testing_core.get_test_id(TestClass.test_method)
    ...
    def test_nested_contexts(self):
        ...
        self.assertEqual(testing_core.get_current_component(), component1)
        
        # Nested context
        get_system().push_context("test_component", component2)
        self.assertEqual(testing_core.get_current_component(), component2)
